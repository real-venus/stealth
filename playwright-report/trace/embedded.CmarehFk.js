...
import { W as M } from "./assets/workbench-DFlGYqou.js";
function S(t, e) {
      ...
      r.useEffect(() => {
        (async () => {
          if (t.length) {
            ...
            (navigator.serviceWorker.addEventListener("message", s), l({ done: 0, total: 1 }));
            const n = [];
      ...
      r.useEffect(() => {
        ...
        d &&
          ((s = window.parent) == null ||
            s.postMessage({ method: "showErrorMessage", params: { message: d } }, "*"));
      }, [d]),
      o.jsxs("div", {
