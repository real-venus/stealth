import { V as yu, W as xu } from "./inspectorTab-B4Iw34Ow.js";
var ho = { exports: {} },
  ha;
function It() {
  return (
        ...
        (function (C, De) {
          ...
          var vi = (function () {
            ...
            return function (u, h) {
              ...
              for (var J = 0, G = v; J < k; ++J) {
                var ee = x[J];
                ee == "1" && G == "r"
                  ? (x[J] = "n")
                  : o.test(ee) && ((G = ee), ee == "r" && (x[J] = "R"));
              }
              ...
              return (
                h == "ltr" &&
                  (gt[0].level == 1 &&
                    (Qt = u.match(/^\s+/)) &&
                    ((gt[0].from = Qt[0].length), gt.unshift(new s(0, 0, Qt[0].length))),
                  ge(gt).level == 1 &&
                    (Qt = u.match(/\s+$/)) &&
                    ((ge(gt).to -= Qt[0].length), gt.push(new s(0, k - Qt[0].length, k)))),
                h == "rtl" ? gt.reverse() : gt
              );
            };
          })();
          ...
          function Wn(e) {
            if (Or == null) {
              var t = d("span", "​");
              (Q(e, d("span", [t, document.createTextNode("x")])),
          ...
          function sr(e) {
            ...
            var t = Q(e, document.createTextNode("AخA")),
...
`,
          ...
          function Ce(e, t) {
            ...
            return t.line > n ? L(n, ce(e, n).text.length) : xa(t, ce(e, t.line).text.length);
          }
          function xa(e, t) {
            var n = e.ch;
          ...
          function bo(e, t, n, r) {
            ...
            var a = ce(i, t.line),
              s = fn(e, t.line, n),
              u = new Qe(a.text, e.options.tabSize, s),
              h;
...
`
          ...
          function Ha(e, t, n) {
            ...
            for (var a = i.length, s = 0, u = 1, h = "", v, k, x = 0, M, E, R, U, J; ; ) {
              if (x == s) {
                ((M = E = R = k = ""), (J = null), (U = null), (x = 1 / 0));
                for (var G = [], ee = void 0, me = 0; me < r.length; ++me) {
                  ...
                  if (Fe.type == "bookmark" && pe.from == s && Fe.widgetNode) G.push(Fe);
                    ...
                    if (
                      ...
                      Fe.title && ((J || (J = {})).title = Fe.title),
                      Fe.attributes)
                    )
                      for (var Ke in Fe.attributes) (J || (J = {}))[Ke] = Fe.attributes[Ke];
              ...
              for (var Mt = Math.min(a, x); ; ) {
                if (h) {
                  ...
                  if (!U) {
                    ...
                    t.addToken(t, tt, v ? v + M : M, R, s + tt.length == x ? E : "", k, J);
                  }
                  if (wt >= Mt) {
                    ((h = h.slice(Mt - s)), (s = Mt));
                    break;
          ...
          function ot(e, t) {
            ...
            if (n.length) {
              var r = Array.prototype.slice.call(arguments, 2),
                i;
              Rr ? (i = Rr.delayedCallbacks) : dn ? (i = dn) : ((i = dn = []), setTimeout(Ka, 0));
              for (
                var o = function (a) {
                    i.push(function () {
          ...
          function pn(e) {
            ...
            if (!m(document.body, e.node)) {
              ...
              (e.coverGutter && (n += "margin-left: -" + t.display.gutters.offsetWidth + "px;"),
                ...
                Q(t.display.measure, d("div", [e.node], null, n)));
            }
          ...
          function Ho(e) {
            ...
            var t = Q(e.measure, d("pre", "x", "CodeMirror-line-like")),
          ...
          function Ja(e, t) {
            ...
            return ((r.text = i.pre), Q(e.display.lineMeasure, i.pre), r);
          }
          function qo(e, t, n, r) {
          ...
          function qr(e, t) {
            ...
            (r && !r.text
              ? (r = null)
              : r && r.changes && (Io(e, r, n, Pi(e)), (e.curOp.forceUpdate = !0)),
              r || (r = Ja(e, t)));
            var i = Ro(r, t, n);
            return {
              line: t,
            ...
            return (
              t.cache.hasOwnProperty(o)
                ...
                : (t.rect || (t.rect = t.view.text.getBoundingClientRect()),
                  t.hasHeights || (Qa(e, t.view, t.rect), (t.hasHeights = !0)),
                  (l = $a(e, t, n, r)),
                  l.bogus || (t.cache[o] = l)),
              {
                left: l.left,
              ...
              for (var h = 0; h < 4; h++) {
                ...
                if (
                  (b && N < 9 && l == 0 && a == i.coverEnd - i.coverStart
                    ...
                    : (u = Va(w(o, l, a).getClientRects(), r)),
                  u.left || u.right || l == 0)
                )
                  break;
                ((a = l), (l = l - 1), (s = "right"));
              }
              b && N < 11 && (u = es(e.display.measure, u));
            } else {
              l > 0 && (s = r = "right");
              var v;
          ...
          function Ni(e, t, n) {
            ...
            var i = g(r, n),
              o = r.first + r.size - 1;
            if (i > o) return Ei(r.first + r.size - 1, ce(r, o).text.length, null, 1, 1);
            t < 0 && (t = 0);
            for (var l = ce(r, i); ; ) {
              var a = ts(e, l, i, t, n),
                s = Fa(l, a.ch + (a.xRel > 0 || a.outside > 0 ? 1 : 0));
              if (!s) return a;
              var u = s.find(1);
          ...
          function ts(e, t, n, r, i) {
            ...
            if (h) {
              var v = (e.options.lineWrapping ? ns : rs)(e, t, n, o, h, r, i);
            ...
            var k = null,
              ...
              U = !1;
            if (x) {
              var J = r - x.left < x.right - r,
                G = J == u;
              ((M = k + (G ? 0 : 1)), (R = G ? "after" : "before"), (E = J ? x.left : x.right));
            } else {
              (!u && (M == s || M == a) && M++,
                (R =
                  M == 0
          ...
          function os(e, t, n) {
            ...
            function v(G, ee, me) {
              ...
              return (
                or(wt, ee || 0, me ?? Fe, function (tt, St, ft, nt) {
                  var rt = ft == "ltr",
                    Je = Xe(tt, rt ? "left" : "right"),
                    Tt = Xe(St - 1, rt ? "right" : "left"),
                    nn = ee == null && tt == 0,
                    xr = me == null && St == Fe,
                    gt = nt == 0,
                    Qt = !wt || nt == wt.length - 1;
                  if (Tt.top - Je.top <= 3) {
                    var ut = (u ? nn : xr) && gt,
                      fo = (u ? xr : nn) && Qt,
                      ir = ut ? a : (rt ? Je : Tt).left,
                      Ar = fo ? s : (rt ? Tt : Je).right;
                    h(ir, Je.top, Ar - ir, Je.bottom);
                  } else {
                    var Er, mt, on, co;
                    (rt
                      ? ((Er = u && nn && gt ? a : Je.left),
                        (mt = u ? s : Mt(tt, ft, "before")),
                        (on = u ? a : Mt(St, ft, "after")),
                        (co = u && xr && Qt ? s : Tt.right))
                      : ((Er = u ? Mt(tt, ft, "before") : a),
                        (mt = !u && nn && gt ? s : Je.right),
                        (on = !u && xr && Qt ? a : Tt.left),
                        (co = u ? Mt(St, ft, "after") : s)),
                      h(Er, Je.top, mt - Er, Je.bottom),
                      Je.bottom < Tt.top && h(a, Je.bottom, null, Tt.top),
            ...
            if (k.line == x.line) v(k.line, k.ch, x.ch);
              ...
              var M = ce(i, k.line),
                ...
                J = v(x.line, R ? 0 : null, x.ch).start;
              (R &&
                (U.top < J.top - 2
                  ? (h(U.right, U.top, null, U.bottom), h(a, J.top, J.left, J.bottom))
                  : h(U.right, U.top, J.left - U.right, U.bottom)),
                U.bottom < J.top && h(a, U.bottom, null, J.top));
            }
            n.appendChild(o);
          }
          function Wi(e) {
          ...
          function cs(e) {
            ...
            for (var o = 0; o < t.length; o++) gs(t[o]);
          ...
          function kn(e, t) {
            e.doc.highlightFrontier < e.display.viewTo && e.state.highlight.set(t, ue(ms, e));
          }
          function ms(e) {
            var t = e.doc;
          ...
          function ji(e, t) {
            ...
            return (
              ...
              ks(e, n.updateLineNumbers, t.dims),
            ...
            for (var n = t.viewport, r = !0; ; r = !1) {
              if (!r || !e.options.lineWrapping || t.oldDisplayWidth == wr(e)) {
                if (
                  (n &&
                    n.top != null &&
                    (n = { top: Math.min(e.doc.height + Di(e.display) - Mi(e), n.top) }),
          ...
          function Qi(e, t, n, r) {
            ...
            function o(J, G, ee) {
              (Na(J, G, ee, r), ot(J, "change", J, t));
            }
            function l(J, G) {
              for (var ee = [], me = J; me < G; ++me) ee.push(new Hr(u[me], i(me), r));
              return ee;
            }
            var a = t.from,
              s = t.to,
            ...
            if (
              ...
              ((a = ge(l.changes)),
                Z(t.from, t.to) == 0 && Z(t.from, a.to) == 0
                  ? (a.to = gr(t))
                  : l.changes.push(Ji(e, t)));
            else {
              var s = ge(i.done);
              for (
                (!s || !s.ranges) && ii(e.sel, i.done),
                  l = { changes: [Ji(e, t)], generation: i.generation },
                  i.done.push(l);
          ...
          function Ms(e, t, n, r) {
            ...
            (o &&
              i.lastSelOrigin == o &&
              ((i.lastModTime == i.lastSelTime && i.lastOrigin == o) || Ds(e, o, ge(i.done), t)))
          ...
          function As(e, t) {
            var n = t["spans_" + e.id];
            if (!n) return null;
            for (var r = [], i = 0; i < t.text.length; ++i) r.push(Fs(n[i]));
            return r;
          }
          function Sl(e, t) {
            var n = As(e, t),
          ...
          function Qr(e, t, n) {
            if (e.cm) {
              if (!e.cm.curOp) return lt(e.cm, Qr)(e, t, n);
                ...
                for (
                  var v = Ct(e, "beforeChange") || (e.cm && Ct(e.cm, "beforeChange")),
                    k = function (E) {
                      ...
                      var J = [];
                      vr(e, function (G, ee) {
                        (!ee && oe(J, G.history) == -1 && (Bl(G.history, R), J.push(G.history)),
                          Tn(G, R, null, Sl(G, R)));
                      });
                    },
          ...
          Cn.prototype = {
            ...
            removeInner: function (e, t) {
              for (var n = e, r = e + t; n < r; ++n) {
                var i = this.lines[n];
                ((this.height -= i.height), Oa(i), ot(i, "delete"));
              }
            ...
            return (
              ...
              Ln(e, t, "widget", function (l) {
                ...
                if (
                  ...
                  (Ft(l, l.height + pn(i)), s && qi(o, i.height), (o.curOp.forceUpdate = !0));
                }
                return !0;
              }),
            ...
            if (!this.explicitlyCleared) {
              ...
              for (var r = null, i = null, o = 0; o < this.lines.length; ++o) {
                ...
                (e && !this.collapsed
                  ...
                  (l.markedSpans = Ta(l.markedSpans, a)),
                  a.from == null &&
                    this.collapsed &&
                    !cr(this.doc, l) &&
                    e &&
          ...
          function Vr(e, t, n, r, i) {
            ...
            if (
              ...
              o.readOnly &&
                (wa(), (e.history.done.length || e.history.undone.length) && e.clearHistory()),
          ...
          ((kt.prototype = F(Dn.prototype, {
            ...
            replaceRange: function (e, t, n, r) {
              ((t = Ce(this, t)), (n = n ? Ce(this, n) : t), Jr(this, e, t, n, r));
            },
            ...
            unlinkDoc: function (e) {
              if ((e instanceof Ge && (e = e.doc), this.linked))
                for (var t = 0; t < this.linked.length; ++t) {
                  var n = this.linked[t];
                  if (n.doc == e) {
                    (this.linked.splice(t, 1), e.unlinkDoc(this), zs(Hl(this)));
                    break;
                  }
                }
...
`
                      ...
                      a = function () {
                        ++l == i &&
                          lt(t, function () {
                            ...
                            (Qr(t.doc, x), Cl(t.doc, pr(Ce(t.doc, n), Ce(t.doc, gr(x)))));
                          })();
                      },
                      s = function (x, M) {
                        if (
                  ...
                  try {
                    ...
                    if (h) {
                      ...
                      if (
                        ...
                        for (var k = 0; k < v.length; ++k)
                          Jr(t.doc, "", v[k].anchor, v[k].head, "drag");
          ...
          function Us(e) {
            ...
            for (var n in e)
              if (e.hasOwnProperty(n)) {
                ...
                for (var i = Pe(n.split(" "), Ks), o = 0; o < i.length; o++) {
                  var l = void 0,
                    a = void 0;
                  o == i.length - 1
                    ? ((a = i.join(" ")), (l = r))
          ...
          function Gs(e, t, n, r) {
            ...
            if (
              ...
              return to(t, n, r);
            var a = function (U, J) {
                return eo(t, U instanceof L ? U.ch : U, J);
              },
              s,
              u = function (U) {
...
`,
          ...
          function Vl(e) {
            ...
            if (
              ...
              (z &&
                ...
                n == 18 && !/\bCodeMirror-crosshair\b/.test(t.display.lineDiv.className) && Js(t));
            }
          }
          function Js(e) {
          ...
          function ea(e) {
            ...
            if (
              ...
              if (!(z && (!e.which || e.which < 10) && Jl(t, e))) {
                ...
                i != "\b" && (Qs(t, e, i) || t.display.input.onKeyPress(e));
              }
            }
          }
          var Vs = 400,
          ...
          io.prototype.compare = function (e, t, n) {
            return this.time + Vs > e && Z(t, this.pos) == 0 && n == this.button;
          };
          var Pn, In;
          function $s(e, t) {
            var n = +new Date();
          ...
          function iu(e, t, n, r) {
            ...
            function k(G) {
              if (Z(v, G) != 0)
                if (((v = G), r.unit == "rectangle")) {
                  ...
                  var Je = s.ranges.slice(0);
                  ((Je[a] = ou(e, new He(Ce(o, nt), rt))), pt(o, Kt(e, Je, a), ct));
                }
            }
            ...
            function R(G) {
              ((e.state.selectingText = !1),
                ...
                dt(i.wrapper.ownerDocument, "mouseup", J),
            ...
            var U = lt(e, function (G) {
              ...
              J = lt(e, R);
            ((e.state.selectingText = J),
              ve(i.wrapper.ownerDocument, "mousemove", U),
              ve(i.wrapper.ownerDocument, "mouseup", J));
          }
          function ou(e, t) {
            var n = t.anchor,
              r = t.head,
              ...
              n("lineSeparator", null, function (r, i) {
                if (((r.doc.lineSep = i), !!i)) {
                  ...
                  for (var a = o.length - 1; a >= 0; a--)
                    Jr(r.doc, i, o[a], L(o[a].line, o[a].ch + i.length));
                }
              }),
              n(
                "specialChars",
          ...
          function zn(e, t, n, r) {
            ...
            if ((k < h && (v += et(h - k)), v != u))
              return (Jr(i, v, L(t, 0), L(t, u.length), "+input"), (a.stateAfter = null), !0);
...
`) &&
              ...
              moveV: vt(function (r, i) {
                ...
                if (
                  (l.extendSelectionsBy(function (h) {
                    ...
                    var k = ca(o, v, r, i);
                    return (
                      i == "page" && h == l.sel.primary() && qi(o, Zn(o, k, "div").top - v.top),
                      k
                    );
                  }, Oe),
                  a.length)
          ...
          function uo(e, t, n, r, i) {
            ...
            function u() {
              var J = t.line + s;
              return J < e.first || J >= e.first + e.size
                ? !1
                : ((t = new L(J, t.ch, t.sticky)), (a = ce(e, J)));
            }
            function h(J) {
              var G;
              if (r == "codepoint") {
              ...
              } else i ? (G = Gs(e.cm, a, t, n)) : (G = to(a, t, n));
              if (G == null)
                if (!J && u()) t = ro(i, e.cm, a, t.line, s);
                else return !1;
              else t = G;
              return !0;
            }
...
`)));
            ...
            (je.prototype.showMultipleSelections = function (e) {
              (Q(this.cm.display.cursorDiv, e.cursors),
                Q(this.cm.display.selectionDiv, e.selection));
            }),
            ...
            (je.prototype.pollSelection = function () {
              if (!(this.readDOMTimeout != null || this.gracePeriod || !this.selectionChanged())) {
                var e = this.getSelection(),
                  t = this.cm;
                if (re && O && this.cm.display.gutterSpecs.length && du(e.anchorNode)) {
            ...
            (je.prototype.pollContent = function () {
              ...
              if (
                ...
                return !1;
              for (
                var v = e.doc.splitLines(hu(e, a, h, l, u)),
              ...
              for (
                var J = ge(v),
                  G = ge(k),
                  ee = Math.min(
                    J.length - (v.length == 1 ? x : 0),
                    G.length - (k.length == 1 ? x : 0),
                  );
                M < ee && J.charCodeAt(J.length - M - 1) == G.charCodeAt(G.length - M - 1);
              )
                ++M;
              if (v.length == 1 && k.length == 1 && l == r.line)
                for (
                  ;
                  x && x > r.ch && J.charCodeAt(J.length - M - 1) == G.charCodeAt(G.length - M - 1);
                )
                  (x--, M++);
              ((v[v.length - 1] = J.slice(0, J.length - M).replace(/^\u200b+/, "")),
                (v[0] = v[0].slice(x).replace(/\u200b+$/, "")));
              var me = L(l, x),
                pe = L(u, k.length ? ge(k).length - M : 0);
              if (v.length > 1 || v[0] || Z(me, pe)) return (Jr(e.doc, v, me, pe, "+input"), !0);
            }),
                ...
                for (var ee = G < 0 ? s.map : u[G], me = 0; me < ee.length; me += 3) {
                  ...
                  if (pe == R || pe == U) {
                    var Fe = f(G < 0 ? e.line : e.rest[G]),
                      Ke = ee[me] + J;
                    return ((J < 0 || pe != R) && (Ke = ee[me + (J ? 1 : 0)]), L(Fe, Ke));
                  }
                }
            }
            var v = h(l, a, n);
...
`)),
            ...
            ($e.prototype.showSelection = function (e) {
              var t = this.cm,
                n = t.display;
              (Q(n.cursorDiv, e.cursors),
                Q(n.selectionDiv, e.selection),
                e.teTop != null &&
...
`) > -1
      ...
      outline: none; border-width: 0; outline: none; overflow: hidden; opacity: .05; filter: alpha(opacity=5);`));
          ...
          (au(Ge), cu(Ge));
          var mu = "iter insert remove copy getEditor constructor".split(" ");
...
(function (Et, zt) {
  (function (C) {
    ...
    (C.defineMode("javascript", function (De, I) {
      ...
      function y(f) {
        return (
          f == "public" || f == "private" || f == "protected" || f == "abstract" || f == "readonly"
        );
      }
      function P(f, g, A) {
      ...
      function Ue(f, g) {
        return f != "quasi" ? Q() : g.slice(g.length - 2) != "${" ? d(Ue) : d(ct, et);
      }
      function et(f) {
        if (f == "}") return ((D.marked = "string-2"), (D.state.tokenize = Ae), d(Ue));
      }
      function ge(f) {
        return (de(D.stream, D.state), Q(f == "{" ? Le : oe));
      }
      function Pe(f) {
        return (de(D.stream, D.state), Q(f == "{" ? Le : Ne));
      }
      function T(f) {
        return function (g) {
          return g == "."
      ...
      function he(f) {
        return f != "variable" ? Q(Be) : ((D.marked = "property"), d(Pt));
      }
      function Be(f) {
        if (f == ":") return d(Ne);
        if (f == "(") return Q(Pt);
        ...
        function W(L, Z) {
          if (A ? A.indexOf(L) > -1 : L == ",") {
            ...
            return (
              ...
              d(function (it, xt) {
                return it == g || xt == g ? Q() : Q(f);
              }, W)
            );
          }
          return L == g || Z == g ? d() : A && A.indexOf(";") > -1 ? Q(f) : d(Te(g));
        }
        return function (L, Z) {
          return L == g || Z == g ? d() : Q(f, W);
        };
      }
      function Lt(f, g, A) {
      ...
      function lr(f) {
        if (_ && f == ":") return D.stream.match(/^\s*\w+\s+is\b/, !1) ? d(oe, vi, We) : d(We);
      }
      function vi(f, g) {
      ...
      function We(f, g) {
        ...
        if (f == "quasi") return Q(dt, Ot);
      }
      function Bn(f) {
        if (f == "=>") return d(We);
      }
      function ve(f) {
        return f.match(/[\}\)\]]/) ? d() : f == "," || f == ";" ? d(ve) : Q(Jt, ve);
      }
      function Jt(f, g) {
        if (f == "variable" || D.style == "keyword") return ((D.marked = "property"), d(Jt));
        if (g == "?" || f == "number" || f == "string") return d(Jt);
        if (f == ":") return d(We);
        if (f == "[") return d(Te("variable"), br, Te("]"), Jt);
        if (f == "(") return Q(ur, Jt);
        if (!f.match(/[;\}\)\],]/)) return d();
      }
      function dt(f, g) {
        return f != "quasi" ? Q() : g.slice(g.length - 2) != "${" ? d(dt) : d(We, Ye);
      }
      function Ye(f) {
      ...
      function Nr(f, g) {
        return g == "enum" ? ((D.marked = "keyword"), d(ce)) : Q(yt, or, Wt, mi);
      }
      function yt(f, g) {
      ...
      function an(f) {
        return f == "var" ? d(Nr, sr) : f == "variable" ? d(sr) : Q(sr);
      }
      function sr(f, g) {
        return f == ")"
          ? d()
      ...
      function zr(f, g) {
        ...
        if (f == "variable") return Q(Ne, zr);
      }
      function fr(f) {
        return f == "string" ? d() : f == "(" ? Q(oe) : f == "." ? Q(Oe) : Q(Br, Gt, Wr);
      }
      function Br(f, g) {
        return f == "{"
          ? Lt(Br, "}")
      ...
      function ce() {
        return Q(j("form"), yt, Te("{"), j("}"), Me(Vt, "}"), ue, ue);
      }
      function Vt() {
        return Q(yt, Wt);
      }
      ...
      return {
        ...
        indent: function (f, g) {
          ...
          for (
            ...
            (A == "}" ||
              ((L = f.cc[f.cc.length - 1]) && (L == Oe || L == Re) && !/^[,\.=+\-*:?[\(]/.test(g)));
          )
            W = W.prev;
        ...
        function te(re, ne) {
          ...
          if (
            ...
            var ze = re.current() == ">" && _(z[de[1]], de[2]),
              ...
              H = b(de[1], !0),
              Ee = b(de[1], !1);
            ((ne.token = function (D, Q) {
              return D.match(H, !1)
                ? ((Q.token = te), (Q.localState = Q.localMode = null), null)
                : I(D, Ee, Q.localMode.token(D, Q.localState));
            }),
              (ne.localMode = fe),
    ...
    C.defineMode("clike", function (m, y) {
      ...
      return {
        ...
        indent: function (ae, Se) {
          if ((ae.tokenize != T && ae.tokenize != null) || (ae.typeAtEndOfLine && V(ae.context)))
            return C.Pass;
          var he = ae.context,
            Be = Se && Se.charAt(0),
            Me = Be == he.type;
        ...
        for (var le; (le = y.next()); )
          if (le == "*" && y.eat("/"))
            if (m == 1) {
              P.tokenize = null;
              break;
            } else return ((P.tokenize = Q(m - 1)), P.tokenize(y, P));
          else if (le == "/" && y.eat("*")) return ((P.tokenize = Q(m + 1)), P.tokenize(y, P));
        return "comment";
      };
    }
    Ee("text/x-scala", {
      ...
      hooks: {
        ...
        "/": function (m, y) {
          return m.eat("*") ? ((y.tokenize = Q(1)), y.tokenize(m, y)) : !1;
        },
      },
      ...
      function (De, I) {
        ...
        function D(p, c) {
          ...
          if (j === "<" && p.match(/^(https?|ftps?):\/\/(?:[^\\>]|\\.)+>/, !1)) {
            ((c.f = c.inline = Q), I.highlightFormatting && (c.formatting = "link"));
            var Ne = H(c);
          ...
          if (Ae) {
            ...
            if (
              ...
              for (var de = 2; de < Ae.length; de++)
                Ae[de] &&
                  (X.pending || (X.pending = [])).push({ text: Ae[de], token: se.token[de - 1] });
      ...
      return {
        token: function (K, $) {
          ...
          if (($.literal && ($.literal = !1), K.sol())) {
            if (
              (($.keyCol = 0), ($.pair = !1), ($.pairStart = !1), K.match("---") || K.match("..."))
            )
              return "def";
