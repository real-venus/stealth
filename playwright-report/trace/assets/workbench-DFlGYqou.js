...
function ue({
  ...
  const T = h.useMemo(() => me(s, n, m.expandedItems, y || 0, r), [s, n, m, y, r]),
    C = h.useRef(null),
    [k, L] = h.useState(),
    [S, w] = h.useState(!1);
  (h.useEffect(() => {
  ...
  const R = h.useCallback(
    (v) => {
      ...
      if (b) {
        ...
        m.expandedItems.set(v.id, !1);
      } else m.expandedItems.set(v.id, !0);
      x({ ...m });
    },
    [T, n, l, m, x],
  );
    ...
    children: e.jsxs("div", {
      ...
      onKeyDown: (v) => {
        ...
        if (
          ...
          return;
        if ((v.stopPropagation(), v.preventDefault(), n && v.key === "ArrowLeft")) {
          const { expanded: M, parent: p } = T.get(n);
          M ? (m.expandedItems.set(n.id, !1), x({ ...m })) : p && (l == null || l(p));
          return;
        }
        if (n && v.key === "ArrowRight") {
          n.children.length && (m.expandedItems.set(n.id, !0), x({ ...m }));
          return;
        }
        let b = n;
        if (
          (v.key === "ArrowDown" && (n ? (b = T.get(n).next) : T.size && (b = [...T.keys()][0])),
          v.key === "ArrowUp")
        ) {
          if (n) b = T.get(n).prev;
          else if (T.size) {
      ...
      ref: C,
      children: [
        j && T.size === 0 && e.jsx("div", { className: "tree-view-empty", children: j }),
        s.children.map(
          (v) =>
            T.get(v) &&
            e.jsx(
...
function Lt({
  ...
  const N = h.useId(),
    y = h.useRef(null);
  h.useEffect(() => {
    i === t && x && y.current && (qt(y.current), j(!1));
  }, [t, i, x, j]);
  const T = s.get(t),
    C = T.depth,
    k = T.expanded;
  let L = "codicon-blank";
  typeof k == "boolean" && (L = k ? "codicon-chevron-down" : "codicon-chevron-right");
  const S = l(t),
    w = k && t.children.length ? t.children : [],
    R = o == null ? void 0 : o(t),
    v = (m == null ? void 0 : m(t)) || "codicon-blank";
  return e.jsxs("div", {
    ref: y,
    role: "treeitem",
    "aria-selected": t === i,
      ...
      e.jsxs("div", {
        ...
        children: [
          C
            ? new Array(C)
                .fill(0)
                .map((b, M) => e.jsx("div", { className: "tree-view-indent" }, "indent-" + M))
            : void 0,
          e.jsx("div", {
            "aria-hidden": "true",
            className: "codicon " + L,
          ...
          typeof S == "string"
            ? e.jsx("div", { style: { textOverflow: "ellipsis", overflow: "hidden" }, children: S })
            : S,
        ],
      }),
      !!w.length &&
...
function me(t, s, i, a, u = () => !0) {
  if (!u(t)) return new Map();
  const c = new Map(),
    r = new Set();
  ...
  const d = (l, o) => {
    for (const m of l.children) {
      if (!u(m)) continue;
      const x = r.has(m.id) || i.get(m.id),
        j = a > o && c.size < 25 && x !== !1,
        N = m.children.length ? (x ?? j) : void 0,
        y = { depth: o, expanded: N, parent: t === l ? null : l, next: null, prev: n };
      (n && (c.get(n).next = m), (n = m), c.set(m, y), N && d(m, o + 1));
    }
  };
  return (d(t, 0), c);
}
const xe = ue,
  fe = ({
    ...
    const [o, m] = h.useState({ expandedItems: new Map() }),
      { rootItem: x, itemMap: j } = h.useMemo(() => Yt(t), [t]),
      ...
      y = h.useCallback((w) => {
        var R, v;
        return !!((v = (R = w.action) == null ? void 0 : R.error) != null && v.message);
      }, []),
      T = h.useCallback((w) => a({ minimum: w.action.startTime, maximum: w.action.endTime }), [a]),
      C = h.useCallback(
        (w) =>
          ut(w.action, {
            sdkLanguage: u,
      ...
      k = h.useCallback(
        (w) =>
          !i || !w.action || (w.action.startTime <= i.maximum && w.action.endTime >= i.minimum),
        [i],
      ),
      L = h.useCallback(
        (w) => {
      ...
      children: [
        i &&
          e.jsxs("div", {
            ...
            onClick: () => a(void 0),
            children: [e.jsx("span", { className: "codicon codicon-triangle-left" }), "Show all"],
          }),
        e.jsx(xe, {
          name: "actions",
          rootItem: x,
  ...
  ut = (t, s) => {
    ...
    const {
      ...
      m = !!((j = t.attachments) != null && j.length) && !!u;
    let x = "";
    return (
      t.endTime ? (x = B(t.endTime - t.startTime)) : t.error ? (x = "Timed out") : c || (x = "-"),
      e.jsxs(e.Fragment, {
        children: [
          e.jsxs("div", {
            ...
            children: [
              ...
              o && e.jsx("div", { className: "action-selector", title: o, children: o }),
              t.method === "goto" &&
                t.params.url &&
                e.jsx("div", {
          ...
          (r || n || m) && e.jsx("div", { className: "spacer" }),
          m &&
            e.jsx(ot, {
              icon: "attach",
          ...
          r &&
            e.jsx("div", {
              ...
              children: x || e.jsx("span", { className: "codicon codicon-loading" }),
            }),
          n &&
            e.jsxs("div", {
                ...
                !!d &&
                  e.jsxs("div", {
                    ...
                    children: [
                      ...
                      e.jsx("span", { className: "action-icon-value", children: d }),
                    ],
                  }),
                !!l &&
                  e.jsxs("div", {
                    ...
                    children: [
                      ...
                      e.jsx("span", { className: "action-icon-value", children: l }),
                    ],
                  }),
              ],
            }),
        ...
        children: [
          ...
          c &&
            e.jsxs("div", {
              ...
              children: [
                "wall time:",
                e.jsx("span", { className: "call-value datetime", title: c, children: c }),
              ],
            }),
          e.jsxs("div", {
            className: "call-line",
            children: [
              "duration:",
              e.jsx("span", { className: "call-value datetime", title: r, children: r }),
            ],
          }),
        ],
      }),
      !!a.length && e.jsx("div", { className: "call-section", children: "Parameters" }),
      !!a.length && a.map((n, d) => Tt(kt(t, n, i[n], s), "param-" + d)),
      !!t.result && e.jsx("div", { className: "call-section", children: "Return value" }),
      !!t.result &&
        Object.keys(t.result).map((n, d) => Tt(kt(t, n, t.result[n], s), "result-" + d)),
    ],
  });
};
function Tt(t, s) {
    ...
    e.jsxs(
      "div",
      {
        ...
        children: [
          t.name,
          ":",
          e.jsx("span", { className: O("call-value", t.type), title: t.text, children: i }),
...
function kt(t, s, i, a) {
  ...
  if (
    ...
    return { text: St(a || "javascript", t.params.selector), type: "locator", name: "locator" };
  const c = typeof i;
      ...
      ? e.jsx(ve, {
          ...
          render: (a) =>
            e.jsxs("div", {
              ...
              children: [
                e.jsx("span", { className: "log-list-duration", children: a.time }),
                a.message,
              ],
            }),
          notSelectable: !0,
...
const be = ({ errorsModel: t, sdkLanguage: s, revealInSource: i }) =>
                      ...
                      children: [
                        ...
                        c &&
                          e.jsxs("div", {
                            ...
                            children: [
                              "@ ",
                              e.jsx("span", { title: r, onClick: () => i(u), children: c }),
                            ],
                          }),
                      ],
                    }),
  ...
  Te = ({ model: t, boundaries: s, previewPoint: i }) => {
    ...
    if (c.current && i) {
      ...
      r = ((i.clientY - x.top + c.current.scrollTop) / ye) | 0;
    }
    const n =
      (m = (o = t == null ? void 0 : t.pages) == null ? void 0 : o[r]) == null
        ? void 0
        : m.screencastFrames;
    let d, l;
    if (i !== void 0 && n && n.length) {
      const x = s.minimum + ((s.maximum - s.minimum) * i.x) / a.width;
      d = n[Ct(n, x, Rt) - 1];
      const j = {
      ...
      children: [
        e.jsx("div", {
          ...
          children:
            t == null
              ? void 0
              : t.pages.map((x, j) =>
                  x.screencastFrames.length
                    ? e.jsx(ke, { boundaries: s, page: x, width: a.width }, j)
                    : null,
                ),
        }),
        (i == null ? void 0 : i.x) !== void 0 &&
          e.jsxs("div", {
            ...
            style: { top: a.bottom + 5, left: Math.min(i.x, a.width - (l ? l.width : 0) - 10) },
            children: [
              i.action &&
                e.jsx("div", { className: "film-strip-hover-title", children: ut(i.action, i) }),
              d &&
                l &&
                e.jsx("div", {
  ...
  ke = ({ boundaries: t, page: s, width: i }) => {
    ...
    for (const y of u)
      ((a.width = Math.max(a.width, y.width)), (a.height = Math.max(a.height, y.height)));
    const c = Dt(a, zt),
      r = u[0].timestamp,
      ...
      l = ((r - t.minimum) / d) * i,
      o = ((t.maximum - n) / d) * i,
      x = ((((n - r) / d) * i) / (c.width + 2 * q)) | 0,
      j = (n - r) / x,
      N = [];
    for (let y = 0; r && j && y < x; ++y) {
      const T = r + j * y,
        C = Ct(u, T, Rt) - 1;
      N.push(
        e.jsx(
...
const Me = ({
  ...
  const [o, m] = dt(),
    ...
    [N, y] = h.useState(),
    {
      ...
      let p = n || s;
      if (x && x.startX !== x.endX) {
        const W = I(o.width, s, x.startX),
          P = I(o.width, s, x.endX);
  ...
  const S = h.useCallback(
      (p) => {
        if ((y(void 0), !m.current)) return;
        const f = p.clientX - m.current.getBoundingClientRect().left,
          z = I(o.width, s, f),
        ...
        n && Math.abs(f - D) < 10
          ...
          : n && Math.abs(f - W) < 10
            ...
            : n &&
                z > n.minimum &&
                z < n.maximum &&
                p.clientY - m.current.getBoundingClientRect().top < 20
    ...
    w = h.useCallback(
      (p) => {
        ...
        if ((D && a(D), !x)) return;
        let W = x;
        if (x.type === "resize") W = { ...x, endX: f };
        else {
          const F = f - x.pivot;
          let X = x.startX + F,
            $ = x.endX + F;
          (X < 0 && ((X = 0), ($ = X + (x.endX - x.startX))),
            $ > o.width && (($ = o.width), (X = $ - (x.endX - x.startX))),
            (W = { ...x, startX: X, endX: $, pivot: f }));
        }
        j(W);
        const P = I(o.width, s, W.startX),
          H = I(o.width, s, W.endX);
    ...
    R = h.useCallback(() => {
      if ((y(void 0), !!x)) {
        if (x.startX !== x.endX) {
          const p = I(o.width, s, x.startX),
            f = I(o.width, s, x.endX);
          d({ minimum: Math.min(p, f), maximum: Math.max(p, f) });
        } else {
          const p = I(o.width, s, x.startX),
            f = t == null ? void 0 : t.actions.findLast((z) => z.startTime <= p);
          (f && a(f), d(void 0));
        }
        j(void 0);
      }
  ...
  return e.jsxs("div", {
    ...
    children: [
      !!x &&
        e.jsx(te, {
          cursor: (x == null ? void 0 : x.type) === "resize" ? "ew-resize" : "grab",
          onPaneMouseUp: R,
          onPaneMouseMove: w,
          onPaneDoubleClick: M,
        }),
        ...
        children: [
          ...
          n &&
            e.jsxs("div", {
              ...
              children: [
                e.jsx("div", { className: "timeline-window-curtain left", style: { width: C } }),
                e.jsx("div", { className: "timeline-window-resizer", style: { left: -5 } }),
                e.jsx("div", {
                  className: "timeline-window-center",
                  children: e.jsx("div", { className: "timeline-window-drag" }),
                }),
                e.jsx("div", { className: "timeline-window-resizer", style: { left: 5 } }),
                e.jsx("div", { className: "timeline-window-curtain right", style: { width: k } }),
              ],
            }),
        ],
      }),
...
function Se(t, s) {
  ...
  ((r = Math.pow(10, n)), r * c >= 5 * 64 && (r = r / 5), r * c >= 2 * 64 && (r = r / 2));
  const d = s.minimum;
  let l = s.maximum;
  ...
  for (let m = 0; m < a; ++m) {
    const x = d + r * m;
    o.push({ position: A(t, s, x), time: x });
  }
  return o;
}
function A(t, s, i) {
...
const Le = ({ model: t }) => {
  ...
  return t
    ? e.jsxs("div", {
        ...
        style: { flexShrink: 0 },
        children: [
          e.jsx("div", { className: "call-section", style: { paddingTop: 2 }, children: "Time" }),
          !!t.wallTime &&
            e.jsxs("div", {
              className: "call-line",
              children: [
          ...
          t.options.viewport &&
            e.jsxs("div", {
              ...
              children: [
                ...
                e.jsx("span", {
                  className: "call-value number",
                  title: String(!!((s = t.options.viewport) != null && s.width)),
          ...
          t.options.viewport &&
            e.jsxs("div", {
              ...
              children: [
                ...
                e.jsx("span", {
                  className: "call-value number",
                  title: String(!!((i = t.options.viewport) != null && i.height)),
          ...
          e.jsxs("div", {
            ...
            children: [
              "pages:",
              e.jsx("span", { className: "call-value number", children: t.pages.length }),
            ],
          }),
          e.jsxs("div", {
            className: "call-line",
            children: [
              "actions:",
              e.jsx("span", { className: "call-value number", children: t.actions.length }),
            ],
          }),
          e.jsxs("div", {
            className: "call-line",
            children: [
              "events:",
              e.jsx("span", { className: "call-value number", children: t.events.length }),
            ],
          }),
        ],
      })
...
const ht = {
    ...
    h.useEffect(() => {
      (async () => {
        ...
        (d(await lt((M = t.expected) == null ? void 0 : M.attachment.path)),
          ...
          x(await lt((f = t.actual) == null ? void 0 : f.attachment.path)),
          N(await lt((z = t.diff) == null ? void 0 : z.attachment.path)));
      })();
    }, [t]);
    const C = n && m && j,
      k = C ? Math.max(n.naturalWidth, m.naturalWidth, 200) : 500,
      L = C ? Math.max(n.naturalHeight, m.naturalHeight, 200) : 500,
          ...
          children: [
            e.jsxs("div", {
              ...
              children: [
                ...
                e.jsx("div", {
                  style: { ...b, fontWeight: a === "expected" ? 600 : "initial" },
                  onClick: () => u("expected"),
                  children: l,
                }),
                e.jsx("div", {
  ...
  Re = ({
    ...
    const n = { position: "absolute", top: 0, left: 0 },
      [d, l] = h.useState(i / 2),
      o = t.naturalWidth === s.naturalWidth && t.naturalHeight === s.naturalHeight;
    return e.jsxs("div", {
      style: {
        flex: "none",
        display: "flex",
      ...
      children: [
        !r &&
          e.jsxs("div", {
            ...
            children: [
              !o &&
                e.jsx("span", { style: { flex: "none", margin: "0 5px" }, children: "Expected " }),
              e.jsx("span", { children: t.naturalWidth }),
              e.jsx("span", { style: { flex: "none", margin: "0 5px" }, children: "x" }),
              ...
              !o && e.jsx("span", { style: { flex: "none", margin: "0 5px" }, children: "x" }),
              !o && e.jsx("span", { children: s.naturalHeight }),
            ],
          }),
        e.jsxs("div", {
          style: { position: "relative", width: i, height: a, margin: 15, ...ht },
          children: [
            e.jsx(ee, {
            ...
            e.jsx("div", {
              ...
              children: e.jsx("img", {
                alt: "Actual",
                style: { width: s.naturalWidth * u, height: s.naturalHeight * u },
                draggable: "false",
                src: s.src,
              }),
            }),
      ...
      children: [
        !a &&
          e.jsxs("div", {
            style: { margin: 5 },
            children: [
              s && e.jsx("span", { style: { flex: "none", margin: "0 5px" }, children: s }),
              e.jsx("span", { children: t.naturalWidth }),
              e.jsx("span", { style: { flex: "none", margin: "0 5px" }, children: "x" }),
              e.jsx("span", { children: t.naturalHeight }),
            ],
        ...
        e.jsx("div", {
          style: { display: "flex", flex: "none", width: u, height: c, margin: 15, ...ht },
          children: e.jsx("img", {
...
const We = ({ title: t, children: s, setExpanded: i, expanded: a, expandOnTitleClick: u }) => {
  const c = h.useId();
  return e.jsxs("div", {
    ...
    children: [
      e.jsxs("div", {
        ...
        children: [
          e.jsx("div", {
            className: O("codicon", a ? "codicon-chevron-down" : "codicon-chevron-right"),
      ...
      a && e.jsx("div", { id: c, role: "region", style: { marginLeft: 25 }, children: s }),
    ],
  });
};
function Wt(t) {
...
function Ae(t) {
  ...
  return (
    ...
    e.jsx("a", { href: s, target: "_blank", rel: "noopener noreferrer", children: t })
  );
}
const Ee = ({ attachment: t, reveal: s, highlight: i }) => {
    ...
    (h.useEffect(() => {
      var N;
      s && ((N = l.current) == null || N.scrollIntoView({ behavior: "smooth" }));
    }, [s]),
      h.useEffect(() => {
        a &&
          c === null &&
...
`).length
      ...
      j = e.jsxs("span", {
        ...
        "aria-label": t.name,
        children: [
          e.jsx("span", { className: O(i && "attachment-title-highlight"), children: Wt(t.name) }),
          m && e.jsx("a", { style: { marginLeft: 5 }, href: tt(t), children: "download" }),
        ],
      });
    return !o || !m
  ...
  Xe = ({ model: t, selectedAction: s, revealedAttachment: i }) => {
    const {
      diffMap: a,
      screenshots: u,
      attachments: c,
      ...
      for (const l of (t == null ? void 0 : t.actions) || []) {
        ...
        for (const m of l.attachments || []) r.add({ ...m, traceUrl: o });
      }
      const d = new Map();
      for (const l of r) {
        ...
        if (o) {
          const m = o[1],
            x = o[2],
            j = d.get(m) || { expected: void 0, actual: void 0, diff: void 0 };
          ((j[x] = l), d.set(m, j), r.delete(l));
    ...
    return !a.size && !u.size && !c.size
      ...
      : e.jsxs("div", {
          ...
          children: [
            [...a.values()].map(({ expected: r, actual: n, diff: d }) =>
              e.jsxs(e.Fragment, {
                children: [
                  r &&
                    n &&
                    e.jsx("div", { className: "attachments-section", children: "Image diff" }),
                  r &&
                    n &&
                    e.jsx(ze, {
                      noTargetBlank: !0,
                      diff: {
                        name: "Image diff",
                        expected: { attachment: { ...r, path: tt(r) }, title: "Expected" },
                        actual: { attachment: { ...n, path: tt(n) } },
                        diff: d ? { attachment: { ...d, path: tt(d) } } : void 0,
                      },
                    }),
                ],
              }),
            ...
            u.size
              ? e.jsx("div", { className: "attachments-section", children: "Screenshots" })
              : void 0,
            [...u.values()].map((r, n) => {
              const d = mt(r);
              return e.jsxs(
                "div",
                {
                  ...
                  children: [
                    e.jsx("div", { children: e.jsx("img", { draggable: "false", src: d }) }),
                    e.jsx("div", {
                      children: e.jsx("a", {
                        target: "_blank",
                        href: d,
            ...
            c.size
              ? e.jsx("div", { className: "attachments-section", children: "Attachments" })
              : void 0,
            [...c.values()].map((r, n) => {
              var d;
              return e.jsx(
        ...
        children: t.map((s, i) =>
          e.jsxs(
            "div",
            {
              ...
              children: [
                e.jsx("span", { style: { fontWeight: "bold" }, children: s.type }),
                s.description && e.jsxs("span", { children: [": ", Wt(s.description)] }),
              ],
            },
            `annotation-${i}`,
          ),
...
const Be = ({
  ...
  const [x, j] = h.useState(void 0),
    ...
    [W, P] = h.useState(""),
    [H, F] = h.useState(),
    [X, $] = wt("propertiesSidebarLocation", "bottom"),
    st = h.useCallback((g) => {
      (j(g == null ? void 0 : g.callId), y(void 0));
    }, []),
    it = h.useMemo(() => (t == null ? void 0 : t.actions.find((g) => g.callId === k)), [t, k]),
    nt = h.useCallback((g) => {
  ...
  const Y = h.useMemo(() => {
      if (x) {
        const K = t == null ? void 0 : t.actions.find((_) => _.callId === x);
        if (K) return K;
      }
  ...
  const at = ae(t, H),
    ...
    Ft = { id: "call", title: "Call", render: () => e.jsx(ge, { action: V, sdkLanguage: G }) },
    Ut = { id: "log", title: "Log", render: () => e.jsx(je, { action: V, isLive: u }) },
    Bt = {
      id: "errors",
      title: "Errors",
  ...
  const rt = {
      ...
      render: () =>
        e.jsx(de, {
          ...
          sources: At,
          rootDir: i,
          stackFrameLocation: X === "bottom" ? "right" : "bottom",
          fallbackLocation: a,
          onOpenExternally: o,
        }),
    },
    ...
    $t = {
      ...
      render: () => e.jsx(le, { boundaries: ct, networkModel: pt, onEntryHovered: w }),
    },
    Vt = {
      id: "attachments",
      title: "Attachments",
      count: Pt.length,
      render: () => e.jsx(Xe, { model: t, selectedAction: Y, revealedAttachment: T }),
    },
  ...
  const _t = {
          ...
          r &&
            e.jsxs("div", {
              ...
              children: [
                ...
                e.jsx("div", { className: "workbench-run-duration", children: Z ? B(Z) : "" }),
              ],
            }),
          e.jsx(fe, {
            sdkLanguage: G,
    ...
    Gt = { id: "metadata", title: "Metadata", component: e.jsx(Le, { model: t }) };
  return e.jsxs("div", {
    ...
    children: [
      ...
      e.jsx(Nt, {
        sidebarSize: 250,
        orientation: X === "bottom" ? "vertical" : "horizontal",
        ...
        main: e.jsx(Nt, {
          ...
          main: e.jsx(oe, {
            ...
            setIsInspecting: ft,
            highlightedLocator: W,
            setHighlightedLocator: Xt,
            openPage: l,
          }),
          sidebar: e.jsx(bt, { tabs: [_t, Gt], selectedTab: b, setSelectedTab: M }),
        }),
        sidebar: e.jsx(bt, {
          tabs: J,
          selectedTab: p,
