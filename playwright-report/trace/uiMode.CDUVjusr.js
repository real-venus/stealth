...
import {
  ...
  a as He,
  c as qe,
} from "./assets/inspectorTab-B4Iw34Ow.js";
import { T as Ye, W as Qe } from "./assets/testServerConnection-DeE2kSzz.js";
import { E as Xe, t as Ge, T as Je, W as Ze } from "./assets/workbench-DFlGYqou.js";
var et = {};
class oe {
  constructor(e, t = {}) {
    ((this.isListing = !1),
  ...
  _mergeTestInto(e, t) {
    let s = this._options.mergeTestCases
      ? t.tests.find((o) => o.title === e.title && o.repeatEachIndex === e.repeatEachIndex)
      : void 0;
    (s ||
      ((s = new tt(e.testId, e.title, this._absoluteLocation(e.location), e.repeatEachIndex)),
      t._addTest(s),
  ...
  for (const o of i.results)
    o.status === "interrupted" ||
      (o.status === "skipped" && i.expectedStatus === "skipped"
        ? ++e
        : o.status === "skipped" || (o.status === i.expectedStatus ? ++t : ++s));
  return t === 0 && s === 0
    ? "skipped"
    : s === 0
      ? "expected"
...
class ne {
  ...
  filterTree(e, t, s) {
    const o = e.trim().toLowerCase().split(" "),
      ...
      a = (l) => {
        const m = [...l.tests[0].titlePath(), ...l.tests[0].tags].join(" ").toLowerCase();
        return !o.every((n) => m.includes(n)) &&
          !l.tests.some((n) => (s == null ? void 0 : s.has(n.id)))
          ? !1
          : ((l.children = l.children.filter(
              (n) => !d || (s == null ? void 0 : s.has(n.test.id)) || t.get(n.status),
            )),
  ...
  testIds() {
    const e = new Set(),
      t = (s) => {
        (s.kind === "case" && s.tests.forEach((o) => e.add(o.id)), s.children.forEach(t));
      };
        ...
        (b.children.forEach(E),
          !u &&
            ...
            ((b.kind === "test" && d.testIds.has(b.test.id)) ||
              (b.kind === "case" && d.testIds.has((P = b.tests[0]) == null ? void 0 : P.id))) &&
            (u = b));
      };
          ...
          children: [
            r.jsxs("div", {
              ...
              children: [
                ...
                u.kind === "case"
                  ? u.tags.map((q) => r.jsx(ht, { tag: q.slice(1), onClick: (J) => H(J, q) }, q))
                  : null,
              ],
            }),
            !!u.duration &&
              ...
              children: [
                ...
                !a &&
                  r.jsx(D, {
                    ...
                    title: "Watch",
                    onClick: () => {
                      (g.value.has(u.id) ? g.value.delete(u.id) : g.value.add(u.id), l({ ...g }));
                    },
...
const wt = ({ item: i, rootDir: e, onOpenExternally: t, revealSource: s, pathSeparator: o }) => {
    var f, S;
    ...
    return (
      h.useEffect(() => {
        ...
        const v = c && c.duration >= 0 && c.attachments.find((j) => j.name === "trace");
        if (v && v.path) {
    ...
    children: i.map(({ value: e, set: t, title: s }) =>
      r.jsx(
        "div",
        {
          className: "setting",
          children: r.jsxs("label", {
            children: [r.jsx("input", { type: "checkbox", checked: e, onClick: () => t(!e) }), s],
          }),
        },
        s,
      ),
  ...
  bt = ({}) => {
    ...
    (h.useEffect(() => {
      ...
      h.useEffect(() => {
        ...
        return (
          (A.resize = (p, T) => {
            ((me = { cols: p, rows: T }), w.resizeTerminalNoReply({ cols: p, rows: T }));
          }),
          () => {
...
`,
      ...
      h.useEffect(() => {
        ...
        const { config: _, rootSuite: p } = n,
          T = _.configFile ? we.getObject(_.configFile + ":projects", void 0) : void 0,
          y = new Map(l);
        for (const B of y.keys()) p.suites.find((F) => F.title === B) || y.delete(B);
        for (const B of p.suites)
          y.has(B.title) || y.set(B.title, !!(T != null && T.includes(B.title)));
        (!T && y.size && ![...y.values()].includes(!0) && y.set(y.entries().next().value[0], !0),
          (l.size !== y.size || [...l].some(([B, F]) => y.get(B) !== F)) && m(y));
      }, [l, n]),
      h.useEffect(() => {
        N && n != null && n.progress ? c(n.progress) : n || c(void 0);
      }, [n, N]));
    const { testTree: Pe } = h.useMemo(() => {
        if (!n) return { testTree: new ne("", new Q("", "root"), [], l, I.pathSeparator) };
        ...
        (_, p) => {
          !w ||
            ...
            (E.current = E.current.then(async () => {
              ...
              {
                for (const k of ((B = n.rootSuite) == null ? void 0 : B.allTests()) || [])
                  if (T.has(k.id)) {
                    k.results = [];
              ...
              (A.write("\x1B[2m—".repeat(Math.max(0, me.cols - y.length)) + y + "\x1B[22m"),
    ...
    const ie = h.useRef(null),
      Me = h.useCallback((_) => {
        var p;
        (_.preventDefault(), _.stopPropagation(), (p = ie.current) == null || p.showModal());
      }, []),
      re = h.useCallback((_) => {
        var p;
        (_.preventDefault(), _.stopPropagation(), (p = ie.current) == null || p.close());
      }, []),
      De = h.useCallback(
        (_) => {
          (re(_),
            ...
            w == null ||
              w.installBrowsers({}).then(async () => {
                s(!1);
                const { hasBrowsers: p } = await (w == null ? void 0 : w.checkBrowsers({}));
                ce(p);
              }));
        },
        [re, w],
            ...
            children: [
              ...
              r.jsxs("div", {
                ...
                children: [
                  ...
                  r.jsx("br", {}),
                  r.jsx("button", { className: "button", onClick: De, children: "Install" }),
                  r.jsx("button", {
            ...
            children: [
                ...
                children: [
                  r.jsxs(Y, {
                    children: [
                      ...
                      r.jsx(D, { icon: "close", title: "Close", onClick: () => s(!1) }),
                    ],
                  }),
                  r.jsx(lt, { source: A }),
                ],
              ...
              r.jsx("div", {
                ...
                children: r.jsx(wt, {
                  pathSeparator: I.pathSeparator,
                  item: v,
                  rootDir: (pe = n == null ? void 0 : n.config) == null ? void 0 : pe.rootDir,
                  revealSource: Ee,
                  onOpenExternally: (_) =>
                    w == null
                      ? void 0
                      : w.openNoReply({
                          location: { file: _.file, line: _.line, column: _.column },
                        }),
                }),
              }),
            ],
          ...
          sidebar: r.jsxs("div", {
            ...
            children: [
              ...
              r.jsxs(Y, {
                noMinHeight: !0,
                children: [
                  !N && !S && r.jsx("div", { className: "section-title", children: "Tests" }),
                  !N &&
                    S &&
                    r.jsx("div", {
              ...
              ee && r.jsx(xt, { settings: [{ value: Ce, set: Be, title: "Dark mode" }] }),
            ],
          }),
        }),
      ],
