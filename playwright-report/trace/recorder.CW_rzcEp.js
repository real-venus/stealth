...
function le(t) {
  ...
  return [...r.entries()].map(([o, i]) =>
    a.jsx(
      "optgroup",
      { label: o, children: i.filter((c) => (c.group || "Debugger") === o).map((c) => s(c)) },
      o,
    ),
  );
}
...
async function de(t) {
  ...
  const r = await (await fetch(`contexts?${e.toString()}`)).json(),
    o = [];
  for (const i of r)
    (i.actions.forEach((c) => o.push(c.type + "@" + c.startTime + "-" + c.endTime)),
...
function pe(t) {
  ...
  switch (e.name) {
    ...
    case "check":
      return { method: "check", apiName: "locator.check", params: { selector: s, strict: !0 } };
    case "uncheck":
      return { method: "uncheck", apiName: "locator.uncheck", params: { selector: s, strict: !0 } };
    case "select":
      return {
        method: "selectOption",
        apiName: "locator.selectOption",
        params: { selector: s, strict: !0, options: e.options.map((o) => ({ value: o })) },
      };
    case "assertChecked":
      return {
        method: "expect",
    ...
    case "assertVisible":
      return {
        ...
        params: { selector: s, expression: "to.be.visible", isNot: !1, timeout: b },
      };
    case "assertSnapshot":
      return {
        method: "expect",
...
const he = $,
  xe = ({ sdkLanguage: t, actions: e, selectedAction: s, onSelectedAction: r }) => {
    const o = n.useCallback((i) => ge(t, i), [t]);
    return a.jsx("div", {
      className: "vbox",
      children: a.jsx(he, { name: "actions", items: e, selectedItem: s, onSelected: r, render: o }),
    });
  },
  ge = (t, e) => {
    ...
    return a.jsx(a.Fragment, {
      children: a.jsxs("div", {
        ...
        children: [
          ...
          i && a.jsx("div", { className: "action-selector", title: i, children: i }),
          s === "goto" &&
            o.url &&
            a.jsx("div", { className: "action-url", title: o.url, children: o.url }),
        ],
      }),
    });
  },
  ...
  fe = ({ guid: t, children: e }) => {
    ...
    const h = n.useMemo(
      () => (s ? { mode: o, actions: c.actions, sources: c.sources, connection: s } : void 0),
      [c, o, s],
    );
  ...
  _dispatchEvent(e, s) {
    ...
    if (e === "setActions") {
      ...
      (this._options.setActions({
        actions: r.filter((i) => i.action.name !== "openPage" && i.action.name !== "closePage"),
        sources: o,
      }),
...
const be = () => {
    const t = new URLSearchParams(window.location.search),
      e = t.get("ws"),
      s = t.get("trace") + ".json";
    return a.jsx(fe, { guid: e, children: a.jsx(ue, { trace: s, children: a.jsx(ve, {}) }) });
  },
  ve = () => {
    ...
    const m = n.useMemo(
      ...
      F = a.jsxs(J, {
        ...
        children: [
          ...
          a.jsx(f, { icon: "eye", title: "Assert visibility", onClick: () => {} }),
          a.jsx(f, { icon: "whole-word", title: "Assert text", onClick: () => {} }),
          a.jsx(f, { icon: "symbol-constant", title: "Assert value", onClick: () => {} }),
          a.jsx(K, {}),
          a.jsx(f, {
            icon: "files",
            title: "Copy",
  ...
  Te = ({
    ...
    const c = n.useContext(v),
      ...
      S = {
        ...
        title: "Source",
        render: () =>
          a.jsx(ae, { sources: h.current, stackFrameLocation: "right", fallbackLocation: i }),
      },
      j = {
        id: "console",
        title: "Console",
  ...
  Se = ({
    ...
    const c = n.useContext(v),
      u = n.useMemo(() => (c == null ? void 0 : c.actions.find((d) => d.callId === e)), [c, e]),
      p = n.useMemo(() => {
        const d = te(u);
